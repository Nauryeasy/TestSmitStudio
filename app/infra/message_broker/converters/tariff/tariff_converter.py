...
from app.infra.message_broker.converters.base import BaseEventConverter


@dataclass
class TariffEventConverter(BaseEventConverter):
    ...
    def register_event(self, event_type: Type[BaseEvent], converter: Callable):
        print(type(self.event_to_message_map))
